...
{\centering \includegraphics[width=.5\textwidth]{figs/anxiety_rasch_itmap.eps}\par}


% ---------------------------------------------------------------Slide-
\foilhead{Modèle à deux paramètres (difficulté et discrimination)}

{\centering \includegraphics[width=.5\textwidth]{figs/anxiety_twopl.eps}\par}


% ---------------------------------------------------------------Slide-
\foilhead{Comparaison des paramètres de difficulté}

{\centering \includegraphics[width=.5\textwidth]{figs/anxiety_itemsdiff.eps}\par}
